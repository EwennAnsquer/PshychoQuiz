...
INSERT INTO SCOREFERMEE(SCOREFRES,SCOREFDEV ) VALUES (2,4),(4,0),(4,0);


INSERT INTO SCORECH(NBPTMULTRES,NBPTMULTDEV) VALUES (1,1),(0,1),(0,2);
...
INSERT INTO QUESTION(LIBELLE ,ENJEU ) VALUES 
      ('Supportez-vous de "perdre" du temps à résoudre des erreurs','mise en jambe'),
      ('A quel point êtes-vous à l"aise avec les Systèmes d"exploitation','Approche'),
      ('Dépannez-vous souvent les problèmes informatiques de votre famille','Approche'),
      ('Avez-vous déjà fouiné dans votre PC','Approche'),
      ('A quel point aimez-vous personnaliser vos projets/réalisations','entamereflexion'),
      ('A quel point êtes-vous perfectionniste','entamereflexion');
